# THIS IS WHERE I WILL PUT UPDATES ON PROGRESS AND RESEARCH
...
## IDEAS:
  - IDEA #1(We'll call it "Alpha"):
    ...
    - It will ask the person in the room how accurate it's assumption was, and if accurate, will then store the data for future reference
...
## OVERVIEW OF WEEK:
- I had thought of two seperate ways to infer the mood of the room, finding the nearest neighbor on a graph, or by using some weighted distances. (write if you chose and how u chose it)
