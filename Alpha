...
QUESTIONS:
  ...
  -How much data does it need to be accurate?                                      ANSWER: I think that taking three measurements in a row, and taking the average, will be the best method
  -Could I make it so it shows a graph?                                            ANSWER: This poses a problem because showing a graph for more than 3 dimensions is hard, but this doesn't matter if I don't need to show it, since the computer can do it wth no problem!
  -How many sensors do I need for an accurate reading?                             ANSWER: 3-5 sensors would work best, having at least a light sensor, noise sensor, and motion sensor
  ...
  -What sensors do I need to get that data?                                        ANSWER: a light sensor, noise sensor, and motion sensor are needed
...
SPECIFIC RESEARCH:
  ...
  -An AI is something that isnt just doing a set program, it needs to learn from the data provided and reach its own end point
  ...
  -I should use data voting and clustering(I dont know what that is yet) to get more accurate results(Alpha.02)
...
PROBLEMS:
  -I dont know how to compare different data sets, especially because they are comparing different units/subjects
